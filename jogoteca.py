...
jogo4 = Jogo('The Dark Pictures Anthology: Man of Medan', 'Survival horror, Narrativa interativa, Adventure', 'Playstation')
jogo5 = Jogo('Uncharted: The lost legacy', 'Ação, Aventura, Tiro', 'Playstation')
jogo6 = Jogo('Mortal Kombat', 'Luta, Multiplayer', 'Playstation')
jogo7 = Jogo('Horizon zero Down', 'Exploração, Aventura', 'Playstation')
jogo8 = Jogo('Last day of june', ' aventura, independente, quebra-cabeça, Adventure', 'Playstation')
jogo9 = Jogo('Far Cry: Primal', 'Aventura, Exploração, Mundo aberto', 'Playstation')
